...
object_1 <- Read10X(data.dir = "single_cell_sequencing/merged_madelon/count/2016_2437_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_1 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2016_2437.csv", header=T, row.names = 1)
...
object_1[["state"]] <- "p2016-2437"
object_1[["source"]] <- "myeloma"
object_1[["genetics"]] <- "hyperdiploid"

# Loading and pre-processing dataset 2
object_2 <- Read10X(data.dir = "single_cell_sequencing/merged_madelon/count/2016_2754_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_2 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2016_2754.csv", header=T, row.names = 1)
...
object_2[["state"]] <- "p2016-2754"
object_2[["source"]] <- "myeloma"
object_2[["genetics"]] <- "hyperdiploid"

# Loading and pre-processing dataset 3
object_3 <- Read10X(data.dir = "single_cell_sequencing/merged_madelon/count/2017_2935_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_3 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2017_2935.csv", header=T, row.names = 1)
...
object_3[["state"]] <- "p2017-2935"
object_3[["source"]] <- "myeloma"
object_3[["genetics"]] <- "hyperdiploid"

# Loading and pre-processing dataset 4
object_4 <- Read10X(data.dir = "single_cell_sequencing/merged_madelon/count/2016_2755_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_4 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2016_2755.csv", header=T, row.names = 1)
...
object_4[["state"]] <- "p2016-2755"
object_4[["source"]] <- "myeloma"
object_4[["genetics"]] <- "hyperdiploid"

# Loading and pre-processing dataset 5
object_5 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2017_3041_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_5 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2017_3041.csv", header=T, row.names = 1)
...
object_5[["state"]] <- "p2017-3041"
object_5[["source"]] <- "myeloma"
object_5[["genetics"]] <- "hyperdiploid"

# Loading and pre-processing dataset 6
object_6 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2017_2908_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_6 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2017_2908.csv", header=T, row.names = 1)
...
object_6[["state"]] <- "p2017-2908"
object_6[["source"]] <- "myeloma"
object_6[["genetics"]] <- "hyperdiploid"

# Loading and pre-processing dataset 7
object_7 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2016_2566_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_7 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2016_2566.csv", header=T, row.names = 1)
...
object_7[["state"]] <- "p2016-2566"
object_7[["source"]] <- "myeloma"
object_7[["genetics"]] <- "translocation"

# Loading and pre-processing dataset 8
object_8 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2017_3057_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_8 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2017_3057.csv", header=T, row.names = 1)
...
object_8[["state"]] <- "p2017-3057"
object_8[["source"]] <- "myeloma"
object_8[["genetics"]] <- "translocation"

# Loading and pre-processing dataset 9
object_9 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2017_3107_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_9 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2017_3107.csv", header=T, row.names = 1)
...
object_9[["state"]] <- "p2017-3127"
object_9[["source"]] <- "myeloma"
object_9[["genetics"]] <- "translocation"

# Loading and pre-processing dataset 10
object_10 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2016_2691_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_10 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2016_2691.csv", header=T, row.names = 1)
...
object_10[["state"]] <- "p2016-2691"
object_10[["source"]] <- "myeloma"
object_10[["genetics"]] <- "del17p"

# Loading and pre-processing dataset 11
object_11 <- Read10X(data.dir = "single_cell_sequencing/run12/2016_2255_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_11 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2016_2255.csv", header=T, row.names = 1)
...
object_11[["state"]] <- "p2016-2255"
object_11[["source"]] <- "myeloma"
object_11[["genetics"]] <- "translocation"

# Loading and pre-processing dataset 12
object_12 <- Read10X(data.dir = "single_cell_sequencing/run12/2016_2429_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_12 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2016_2429.csv", header=T, row.names = 1)
...
object_12[["state"]] <- "p2016-2429"
object_12[["source"]] <- "myeloma"
object_12[["genetics"]] <- "translocation"

# Loading and pre-processing dataset 13
object_13 <- Read10X(data.dir = "single_cell_sequencing/run12/2017_3112_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_13 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2017_3112.csv", header=T, row.names = 1)
...
object_13[["state"]] <- "p2017-3112"
object_13[["source"]] <- "myeloma"
object_13[["genetics"]] <- "del17p"

# Loading and pre-processing dataset 14
object_14 <- Read10X(data.dir = "single_cell_sequencing/merged_madelon/count/2013_1142_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_14 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2013_1142.csv", header=T, row.names = 1)
...
object_14[["state"]] <- "p2013-1142"
object_14[["source"]] <- "control"
object_14[["genetics"]] <- "NA"

# Loading and pre-processing dataset 15
object_15 <- Read10X(data.dir = "single_cell_sequencing/merged_madelon/count/2016_2161_N45/outs/filtered_feature_bc_matrix/")
...
select.cells_object_15 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2016_2161.csv", header=T, row.names = 1)
...
object_15[["state"]] <- "p2016-2161"
object_15[["source"]] <- "control"
object_15[["genetics"]] <- "NA"

# Loading and pre-processing dataset 16
object_16 <- Read10X(data.dir = "single_cell_sequencing/run12/2020_5941_N/outs/filtered_feature_bc_matrix/")
...
select.cells_object_16 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2020_5941.csv", header=T, row.names = 1)
...
object_16[["state"]] <- "p2020-5941"
object_16[["source"]] <- "control"
object_16[["genetics"]] <- "NA"

# Loading and pre-processing dataset 17
object_17 <- Read10X(data.dir = "single_cell_sequencing/run12/2020_5950_N/outs/filtered_feature_bc_matrix/")
...
select.cells_object_17 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_2020_5950.csv", header=T, row.names = 1)
...
object_17[["state"]] <- "p2020-5950"
object_17[["source"]] <- "control"
object_17[["genetics"]] <- "NA"

# Loading and pre-processing dataset 18
object_18 <- Read10X(data.dir = "single_cell_sequencing/run12/HBM_D03_N/outs/filtered_feature_bc_matrix/")
...
select.cells_object_18 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_HBM_D03.csv", header=T, row.names = 1)
...
object_18[["state"]] <- "pHBM_D03"
object_18[["source"]] <- "control"
object_18[["genetics"]] <- "NA"

# Loading and pre-processing dataset 19
object_19 <- Read10X(data.dir = "single_cell_sequencing/run12/HBM_D04_N/outs/filtered_feature_bc_matrix/")
...
select.cells_object_19 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_HBM_D04.csv", header=T, row.names = 1)
...
object_19[["state"]] <- "pHBM_D04"
object_19[["source"]] <- "control"
object_19[["genetics"]] <- "NA"

# Loading and pre-processing dataset 20
object_20 <- Read10X(data.dir = "single_cell_sequencing/run12/HBM_D05_N/outs/filtered_feature_bc_matrix/")
...
select.cells_object_20 <- read.csv(file="Analyses for myself/Paper 2020/Barcodes/barcodes_HBM_D05.csv", header=T, row.names = 1)
