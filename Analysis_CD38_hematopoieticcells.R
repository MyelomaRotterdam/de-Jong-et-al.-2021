...
object_1 <- Read10X(data.dir = "single_cell_sequencing/merged_madelon/count/2016_2437_P38/outs/filtered_feature_bc_matrix/")
object_1 <- CreateSeuratObject(counts = object_1, min.cells = 3, min.features = 200, project = "p2437")
...
object_2 <- Read10X(data.dir = "single_cell_sequencing/merged_madelon/count/2016_2754_P38/outs/filtered_feature_bc_matrix/")
object_2 <- CreateSeuratObject(counts = object_2, min.cells = 3, min.features = 200, project = "p2754")
...
object_3 <- Read10X(data.dir = "single_cell_sequencing/merged_madelon/count/2017_2935_P38/outs/filtered_feature_bc_matrix/")
object_3 <- CreateSeuratObject(counts = object_3, min.cells = 3, min.features = 200, project = "p2935")
...
object_4 <- Read10X(data.dir = "single_cell_sequencing/merged_madelon/count/2016_2755_P38/outs/filtered_feature_bc_matrix/")
object_4 <- CreateSeuratObject(counts = object_4, min.cells = 3, min.features = 200, project = "p2755")
...
object_5 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2017_3041_P38/outs/filtered_feature_bc_matrix/")
object_5 <- CreateSeuratObject(counts = object_5, min.cells = 3, min.features = 200, project = "p3041")
...
object_6 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2017_2908_P38/outs/filtered_feature_bc_matrix/")
object_6 <- CreateSeuratObject(counts = object_6, min.cells = 3, min.features = 200, project = "p2908")
...
object_7 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2016_2566_P38/outs/filtered_feature_bc_matrix/")
object_7 <- CreateSeuratObject(counts = object_7, min.cells = 3, min.features = 200, project = "p2566")
...
object_8 <- Read10X(data.dir = "single_cell_sequencing/run7/count/2017_3057_P38/outs/filtered_feature_bc_matrix/")
object_8 <- CreateSeuratObject(counts = object_8, min.cells = 3, min.features = 200, project = "p3057")
...
object_9 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2017_3107_P38/outs/filtered_feature_bc_matrix/")
object_9 <- CreateSeuratObject(counts = object_9, min.cells = 3, min.features = 200, project = "p3107")
...
object_9[["state"]] <- "p2017-3107"
object_9[["source"]] <- "myeloma"
object_9[["genetics"]] <- "translocation"
object_9[["kit"]] <- "kit2"

# Loading and pre-processing dataset 10
object_10 <- Read10X(data.dir = "single_cell_sequencing/run8/count_madelon/2016_2691_P38/outs/filtered_feature_bc_matrix/")
object_10 <- CreateSeuratObject(counts = object_10, min.cells = 3, min.features = 200, project = "p2691")
...
object_11 <- Read10X(data.dir = "single_cell_sequencing/run12/2016_2255_CD38/outs/filtered_feature_bc_matrix/")
...
object_11 <- subset(x = object_11, subset = nFeature_RNA > 200 & nFeature_RNA <3000 & nCount_RNA >200 & nCount_RNA <12000 & percent.mito <0.1)
...
object_12 <- Read10X(data.dir = "single_cell_sequencing/run12/2016_2429_CD38/outs/filtered_feature_bc_matrix/")
...
object_12 <- subset(x = object_12, subset = nFeature_RNA > 200 & nFeature_RNA <3000 & nCount_RNA >200 & nCount_RNA <25000 & percent.mito <0.1)
...
object_13 <- Read10X(data.dir = "single_cell_sequencing/run12/2017_3112_CD38/outs/filtered_feature_bc_matrix/")
...
object_13 <- subset(x = object_13, subset = nFeature_RNA > 200 & nFeature_RNA <2500 & nCount_RNA >200 & nCount_RNA <15000 & percent.mito <0.1)
...
object_14 <- Read10X(data.dir = "single_cell_sequencing/run10/count/2013_1055_CD38/outs/filtered_feature_bc_matrix")
...
object_14 <- subset(x = object_14, subset = nFeature_RNA > 200 & nFeature_RNA <3000 & nCount_RNA >200 & nCount_RNA <15000 & percent.mito <0.1)
...
object_14[["state"]] <- "p2013-1055"
object_14[["source"]] <- "control"
object_14[["genetics"]] <- "NA"

# Loading and pre-processing dataset 15
object_15 <- Read10X(data.dir = "single_cell_sequencing/run10/count/2013_1244_CD38/outs/filtered_feature_bc_matrix")
...
object_15[["state"]] <- "p2013-1244"
object_15[["source"]] <- "control"
object_15[["genetics"]] <- "NA"

# Loading and pre-processing dataset 16
object_16 <- Read10X(data.dir = "single_cell_sequencing/run10/count/2014_1278_CD38/outs/filtered_feature_bc_matrix")
...
object_16 <- subset(x = object_16, subset = nFeature_RNA > 200 & nFeature_RNA <2500 & nCount_RNA >200 & nCount_RNA <10000 & percent.mito <0.1)
...
object_16[["state"]] <- "p2014-1278"
object_16[["source"]] <- "control"
object_16[["genetics"]] <- "NA"

# Loading and pre-processing dataset 17
object_17 <- Read10X(data.dir = "single_cell_sequencing/run10/count/2014_1395_CD38/outs/filtered_feature_bc_matrix")
...
object_17 <- subset(x = object_17, subset = nFeature_RNA > 200 & nFeature_RNA <4000 & nCount_RNA >200 & nCount_RNA <10000 & percent.mito <0.1)
...
object_17[["state"]] <- "p2014-1395"
object_17[["source"]] <- "control"
object_17[["genetics"]] <- "NA"

# Loading and pre-processing dataset 18
object_18 <- Read10X(data.dir = "single_cell_sequencing/run10/count/2014_1446_CD38/outs/filtered_feature_bc_matrix")
...
object_18 <- subset(x = object_18, subset = nFeature_RNA > 200 & nFeature_RNA <3000 & nCount_RNA >200 & nCount_RNA <10000 & percent.mito <0.1)
...
object_18[["state"]] <- "p2014-1446"
object_18[["source"]] <- "control"
object_18[["genetics"]] <- "NA"

# Identification of integration anchors
reference.list <- c(object_1, object_2, object_3, object_4, object_5, object_6, object_7, 
...
# Identification of integration anchors
reference.list <- c(object_14, object_15, object_16, object_17, object_18)
...
counts <- GetAssayData(myeloma.integrated, assay = "RNA")
counts <- counts[-(which(rownames(counts) %in% c("IGHA2", "IGHG3", "IGHA1", "IGHG4", "IGHG1","IGHG2"))),]
myeloma.integrated <- subset(myeloma.integrated, features = rownames(counts))
